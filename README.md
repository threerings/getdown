...
The latest version of Getdown can be obtained thusly:
  ...
  * Download the pre-built jar file from Maven Central:
    [getdown-1.6.1.jar](http://repo2.maven.org/maven2/com/threerings/getdown/1.6.1/getdown-1.6.1.jar)
  * Obtain the jar artifact via Maven with the following identifier: `com.threerings:getdown:1.6.1`.
